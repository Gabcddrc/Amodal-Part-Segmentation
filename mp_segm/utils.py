...
class Experiment():
    def __init__(self, args):
        ...
        self.experiment = comet_ml.Experiment(
            ...
            project_name="machine-perception-project",
            workspace="jjiang",
        )
        # self.experiment.set_name("attunet_aug_dice_ce")
        self.experiment.set_name("teranet_2")
    ...
    def log_image(self, im, fname, step):
        ...
        self.experiment.log_image(im, name=fname, step=step)
        print(im, fname, step)
